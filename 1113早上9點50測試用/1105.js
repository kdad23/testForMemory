...
// 一開始先執行 開始遊戲的函式啟動遊戲
console.log('after clickung 777777777777777');
startGame();
...
function clicking() 
{
    ...
    let timeoutID = setTimeout(() => 
    {
        ...
        console.log('計算clicking()中的setTimeout跑幾次');
        console.log("將所有卡片翻到背面，不顯示");
...
function countDownTime() 
{
   ...
   let stopsetInterval= setInterval( ()=>{
        ...
        if(countdownTime==0)
        {
            ...
            countdownTime=0;
            width=0;
            console.log('這裡是countdownTime === 0');
            // 設定音樂靜音
            audio.muted = true;
        ...
        {
            clearInterval(stopsetInterval);
            console.log('Victory後清除Interval');
            countdownTime=0;
            width=0;
